...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post cocktails_url, params: { cocktail: { ingredients: @cocktail.ingredients, name: @cocktail.name, preparation: @cocktail.preparation, price: @cocktail.price } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { ingredients: @cocktail.ingredients, name: @cocktail.name, preparation: @cocktail.preparation, price: @cocktail.price } }
